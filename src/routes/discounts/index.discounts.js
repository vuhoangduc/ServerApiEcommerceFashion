...
router.get('/ofShop/:id',asyneHandler(discountController.getAllDiscountCodeOfShop));
router.delete('/deleteDiscount/:id',asyneHandler(discountController.deleteDiscount));
