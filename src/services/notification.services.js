...
const pushNotiToSystem = async ({
  ...
  if (type === "shop-001") {
    ...
    noti_content =
      "Có 1 đơn hàng của bạn đang được yêu cầu trả hàng với lý do " + note;
  }
  ...
  initSocketManager.sendNotification({
    userId: senderId,
...
const listNotiByShop = async ({
  ...
  const match = {
    ...
    noti_senderId: converToObjectIdMongodb(shopId),
  };
  if (type !== "ALL") {
    match["noti_type"] = type;
  }
